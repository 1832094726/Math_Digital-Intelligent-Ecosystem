...
#################### 以下为日志记录 ####################
model_name = 'BERT-ncf-mlp(' + nowTime + ')'
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        _, test_loss, test_accuracy, _ = evaluate_model_on_test_set(recommend_model, test_data, k=top_k, criterion=criterion, batch_size=32)
    ...
    test_ratings, test_loss, test_accuracy, predictions = evaluate_model_on_test_set(recommend_model, test_data, top_k, criterion, batch_size=32)
