...
# 加载训练好的Lora模型
model = PeftModel.from_pretrained(model, model_id="./output/Qwen2_0.5/checkpoint-1100")
...
# 输出为CSV文件
ratings_df.to_csv('./new_data/train/qs_emb.csv', index=False)

print("Ratings matrix has been saved to 'qs_emb.csv'")
