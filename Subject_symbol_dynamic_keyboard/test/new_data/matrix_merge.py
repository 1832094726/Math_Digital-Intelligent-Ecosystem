...
# 输出结果
output_file = "./matrix_data/matrix_new.json"
...
output_filename = "./new_data/train_data_motified.json"
...
with open("./new_data/train_data_motified.json", "r", encoding="utf-8") as f:
    user = json.load(f)
...
# 保存为 CSV 文件
csv_filename = "./new_data/train/rating_data_motified.csv"
