...
test_data_path = "../../Datasets/change_add_test_layer_1_layer_2_layer_3.json"
...
def evaluate_model(model, dataloader, tokenizer, tfidf_vectorizer):
    ...
    # # 获取标签2被错误分类为标签3的数量
    # misclassified_as_label_3 = cm[2, 3]
    # print("标签2被错误分类为标签3的数量:", misclassified_as_label_3)
    ...
    precision, recall, f1, _ = precision_recall_fscore_support(all_labels, all_preds, average=None,
                                                               labels=[0, 1, 2, 3], zero_division=1)
...
def test_model_per_layer(model, layer_idx, batch_size):
    ...
    model_file_name = f"../Train Model_Change/layer1_classifier_if-idf_change.pth"
