...
# 数据集的路径
data_path = "../../Datasets/change_add_train_layer_1_layer_2_layer_3.json"
validation_data_path = "../../Datasets/change_add_val_layer_1_layer_2_layer_3.json"
# 训练设备
...
if __name__ == '__main__':
    ...
    # joblib.dump(tfidf_vectorizer, "tfidf_vectorizer_bert_change.joblib")
    ...
    torch.save(layer1_classifier.state_dict(), "../Train Model_Change/layer1_classifier_if-idf_change.pth")
    ...
    layer2_classifiers = {
        ...
        2: BertClassifier(model_path, labels_num=5, tfidf_features=1000),
    ...
    for key, classifier in layer2_classifiers.items():
        ...
        # 保存模型状态
        # change
        torch.save(classifier.state_dict(), f"../Train Model_Change/layer2_classifier_{key}_if-idf_change.pth")
        # 清理内存
        del classifier
        torch.cuda.empty_cache()
    ...
    layer3_classifiers = {
        ...
        (2, 2): BertClassifier(model_path, labels_num=2, tfidf_features=1000),
    ...
    for (layer_1_label, layer_2_label), classifier in layer3_classifiers.items():
        ...
        # 保存模型状态
        torch.save(classifier.state_dict(), f"../Train Model_Change/layer3_classifier_{layer_1_label}_{layer_2_label}_if-idf_change.pth")
        # 清理内存
        del classifier
        torch.cuda.empty_cache()
