...
def load_saved_models():
    ...
    for i, classifier in layer2_keys_to_labels.items():
        load_model_state_dict(classifier, f"../Train Model_Change/layer2_classifier_{i}_if-idf_change.pth")
    ...
    for key, classifier in layer3_keys_to_labels.items():
        ...
        filename = f"../Train Model_Change/layer3_classifier_{key[0]}_{key[1]}_if-idf_change.pth"
...
if __name__ == "__main__":
    ...
    input_text = "把一个高为20厘米的圆柱的侧面展开得到一个正方形，这个圆柱的侧面积是多少平方厘米？"
